...
public class Solution {
    ...
    private static void spaceOptimized() {
        ...
        System.out.println(SpaceOptimizedSolution.getMaxProfit(Arrays.asList(1, 2, 3, 4, 5, 6, 7)));
        System.out.println(SpaceOptimizedSolution.getMaxProfit(Arrays.asList(7, 6, 5, 4, 3, 2, 1)));
        System.out.println(SpaceOptimizedSolution.getMaxProfit(Arrays.asList(1, 2, 3, 4, 5)));
        System.out.println(SpaceOptimizedSolution.getMaxProfit(Arrays.asList(100, 180, 260, 310, 40, 535, 695)));
        System.out.println(SpaceOptimizedSolution.getMaxProfit(Arrays.asList(4, 2, 2, 2, 4)));
        System.out.println();
    }
}
