class Node:
    def __init__(self, data):
        ...
        self.diameter = self.height = self.size = 1
...
class BinarySearchTree:
    ...
    def recalc_augmentation(self, parent):
        ...
        while parent is not None:
            ...
            left_ht = parent.left.height if parent.left is not None else 0
            right_ht = parent.right.height if parent.right is not None else 0
    ...
    def _show(self, start):
        if start:
            ...
            print(f"Data = {start.data}{' (root)' if start == self.root else ''}, size = {start.size}, ht = {start.height}, diameter = {start.diameter}")
