...
class BinarySearchTree:
    ...
    def recalc_aug(self, parent):
        ...
        while parent is not None:
            left_sz, right_sz = parent.left.size if parent.left is not None else 0, parent.right.size if parent.right is not None else 0
            left_ht, right_ht = parent.left.ht if parent.left is not None else 0, parent.right.ht if parent.right is not None else 0
